module Puppet::Parser::Functions
  newfunction(:generate_storagepools) do |args|
    ...
    self.to_hash.each do |variable,value|
      if variable =~ /^bacula_storagepool_.*$/
        name = variable[14..-1]
        ...
        function_create_resources('bacula::config::storagepool', {name => parameters})
      end
    end

    begin
      function_create_resources('bacula::config::storagepool', args[0])
    rescue => e
