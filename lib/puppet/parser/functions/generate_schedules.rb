module Puppet::Parser::Functions
  newfunction(:generate_schedules) do |args|
    ...
    self.to_hash.each do |variable,value|
      if variable =~ /^bacula_schedule_.*$/
        ...
        function_create_resources('bacula::config::schedule', {name => parameters})
      end
    end

    begin
      function_create_resources('bacula::config::schedule', args[0])
    rescue => e
