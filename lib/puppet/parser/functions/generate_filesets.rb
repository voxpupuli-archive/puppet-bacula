module Puppet::Parser::Functions
  newfunction(:generate_filesets) do |args|
    ...
    self.to_hash.each do |variable,value|
      if variable =~ /^bacula_fileset_.*$/
        ...
        function_create_resources('bacula::config::fileset', {name => parameters})
      end
    end

    begin
      function_create_resources('bacula::config::fileset', args[0])
    rescue => e
